...
const Footer=()=>{
    ...
    return(
        ...
        <div className='footersoc d-flex justify-content-center'>
        ...
        <a aria-hidden='true' className='fa fa-youtube-play' href='https://www.youtube.com/channel/UCzARaaZ1furvIwUaNUsORWQ' id='devso' rel='noreferrer' target='_blank' title='follow us'></a></div>
        <hr/>
